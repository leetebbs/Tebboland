...
const serverUrl = "https://hio2ywdoad1p.usemoralis.com:2053/server";
const appId = "sAIwZONORCUY6RLzuVAhaifBVxzkkcsOdpCt4Yf6";
...
const unassignables =  [ 
                        ...
                        "0xc39d6a9e3a13ec789efaaf599a1421240f1f922421cfcbf0c4bc32bd1eea8d3d",
                        "0xf4898dedf989cba4f40c92cae9dc70ce8877ffa998e3337a0f9b38acb45c956b"
                        ]

//web3 constants
const contractAddress = "0x21E6fBD7a1f6c7420934F2193300DA25C195531E"; //your own contract
...
function drawCanvas(){
    ...
    worldImage.src = 'static/img/tebbotest.png';
    worldImage.onload = () => {
        initializeMap()
    }
}
...
function validateMove(direction) {
    switch(direction){
        ...
        case 'ArrowDown': return !(plotView.plotY == 8);
    }
}
